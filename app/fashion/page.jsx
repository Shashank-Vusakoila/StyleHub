...
export const metadata = {
  title: 'Fashion Finds',
  description: 'Curated Amazon fashion finds — outfits, accessories & wardrobe essentials. Hand-picked for style and value.',
};

export default async function FashionPage() {
  const posts = await getPosts({ category: 'fashion' }).catch(() => []);
      ...
      <main>
        ...
        <section className="relative min-h-[55vh] flex items-end overflow-hidden">
          <div className="absolute inset-0">
            <Image
              src="https://images.unsplash.com/photo-1483985988355-763728e1935b?w=600&q=60"
              alt="Fashion" fill priority
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-5">
              <div>
                <h1 className="font-serif font-300 text-cream-50 mb-4"
                  ...
                  Fashion
                  <br />
                  <span className="text-gold">Finds</span>
                </h1>
                <p className="font-sans text-sm font-300 text-cream-50/60 max-w-md leading-relaxed">
                  Hand-picked outfits, accessories & wardrobe essentials — all shoppable on Amazon India.
                </p>
              </div>
